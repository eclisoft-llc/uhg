CREATE TABLE IF NOT EXISTS COMPACT.MBR_COV CLUSTER BY (LEFT(MBR_COV_SYS_ID,7))(
	...
	COV_END_DT DATE DEFAULT '9999-12-31' NOT NULL 'This is the last day on which the eligibility begins for this period / record.  Will default to the system open ended date for coverage periods that have no actual expiration date.',
	...
	IMDM_ID VARCHAR(100) NULL COMMENT 'Enterprise individual identifier assigned by individual master data management [IMDM].',
	PERS_SYS_ID VARCHAR(100) NULL COMMENT 'Person System Identifier: Behavioral data warehouse system generated key for a individual'
